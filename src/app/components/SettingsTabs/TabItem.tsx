...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
  return (
    <Tabs.Trigger
      value={value}
      className="group relative px-1 pb-4 text-sm font-medium text-zinc-500 outline-none transition-all hover:text-violet-700 data-[state=active]:text-violet-700 dark:text-zinc-200 dark:hover:text-violet-300 dark:data-[state=active]:text-violet-300"
    >
